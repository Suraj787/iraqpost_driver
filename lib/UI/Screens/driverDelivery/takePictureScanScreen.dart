...
class TakePickupScreen extends StatefulWidget {
  const TakePickupScreen({super.key});

  @override
  State<TakePickupScreen> createState() => _TakePickupScreenState();
}

class _TakePickupScreenState extends State<TakePickupScreen> {
            ...
            children: [
              ...
              CustomButtons(
                ...
                onTap: () {
                  ...
                  Get.toNamed(RouteHelper.getPickupScreen());
                },
                noFillData: code == "",
              ),
            ],
